...
{
    public class LongPressBehaviorImageButton : Behavior<ImageButton>
    {
        ...
        public static readonly BindableProperty CommandProperty = BindableProperty.Create(nameof(Command),
            typeof(ICommand), typeof(LongPressBehaviorImageButton), default(ICommand));

        public static readonly BindableProperty CommandParameterProperty =
            BindableProperty.Create(nameof(CommandParameter), typeof(object), typeof(LongPressBehaviorImageButton));
        ...
        public LongPressBehaviorImageButton()
        {
            _isReleased = true;
            _duration = Duration;
        }

        public LongPressBehaviorImageButton(int duration) : this()
        {
            _duration = duration;
        }
