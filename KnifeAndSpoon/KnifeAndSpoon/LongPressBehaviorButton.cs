...
{
    public class LongPressBehaviorButton : Behavior<Button>
    {
        ...
        public static readonly BindableProperty CommandProperty = BindableProperty.Create(nameof(Command),
            typeof(ICommand), typeof(LongPressBehaviorButton), default(ICommand));

        public static readonly BindableProperty CommandParameterProperty =
            BindableProperty.Create(nameof(CommandParameter), typeof(object), typeof(LongPressBehaviorButton));
        ...
        public LongPressBehaviorButton()
        {
            _isReleased = true;
            _duration = Duration;
        }

        public LongPressBehaviorButton(int duration) : this()
        {
            _duration = duration;
        }
